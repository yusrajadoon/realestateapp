...
const Footer = () => {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col justify-center items-start gap-5">
          ...
          <p className="text-slate-200 text-justify">
            ...
            Voluptatibus accusamus alias possimus veniam ipsa amet itaque
        ...
        <div className="flex flex-col justify-center items-start gap-5">
          ...
          <div className="flex justify-center items-center gap-3">
            ...
            <p className="text-slate-200">123 Real Estate Street, City, Country</p>
          </div>
          <div className="flex justify-center items-center gap-3">
            <FaMobile className="text-white size-5" />
            <p className="text-slate-200">+1 (123) 456-7890</p>
          </div>
          <div className="flex justify-center items-center gap-3">
            <FaFax className="text-white size-5" />
            <p className="text-slate-200">+1 (123) 456-7891</p>
          </div>
          <div className="flex justify-center items-center gap-3">
      ...
      <div
        id="icon-box"
        className="bg-red-600 p-4 rounded-full hover:bg-black cursor-pointer fixed lg:bottom-6 right-6"
      >
